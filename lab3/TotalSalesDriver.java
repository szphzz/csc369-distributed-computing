...
public class TotalSalesDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapOutputKeyClass(DateTimeId.class); // output key class for map function
        ...
        job.setPartitionerClass(SalesPartitioner.class); // sets the partitioner
        job.setGroupingComparatorClass(SalesGroupingComparator.class); // sets the grouping comparator
        job.setSortComparatorClass(SalesSortingComparator.class); // sets the sorting comparator
